...
\subtask{a}
z.z.: $|E|=|V|+|F|-2$\\
Induktion über |E|. Im Schritt 2 neue Flächen innen. Anders kann es nicht sein, sonst wäre $G_{n-1}$ nicht konvex.

\subtask{b}
Induktion über n. Im Schritt einen äußeren Punkt (den es geben muss) entfernen.
\end{task}
