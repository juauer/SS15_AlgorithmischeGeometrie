...
Für diesen Ansatz muss man allerdings:
\begin{itemize}
\item Projizieren können
\item Das Sichtbarkeitsproblem lösen können
\end{itemize}
was vermutlich nicht als Brute-Force-Ansatz durchgeht ...
