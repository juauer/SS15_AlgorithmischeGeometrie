...
Um Links- und Rechtskurven zu prüfen, wird die Determinante einer $2\times 2$-Matrix bestimmt, welche sich aus den zwei Vektoren der folgenden drei Punkte zusammensetzt. $p2$ ist der letzte Punkt auf dem Stack, $p2$ der vorletzte Punkt und $p1$ der Punkt der aktuell betrachtet wird. Es wird getestet ob $\overline{p2~p1}$ links oder rechts von $\overline{p2~p3}$ liegt.\\
